...
import { QuoteMeComponent } from './components/quote-me/quote-me.component';

const routes: Routes = [
  {path: '', component: HomePageComponent},
  {path: 'quote-me', component: QuoteMeComponent},
  {path: 'our-solutions', component: OurSolutionsPageComponent},
  {path: 'our-solutions/:name', component: SolutionPageComponent},
  {path: 'our-products', component: OurProductsPageComponent},
  {path: 'mdvr', component: MdvrComponent},
  {path: 'mdvr/:name', component: ProductPageComponent},
  ...
  {path: 'cameras/:category/:name', component: ProductPageComponent},
  {path: 'analog', redirectTo: 'cameras/analog'},
  {path: 'ip', redirectTo: 'cameras/ip'},
  {path: 'ahd', redirectTo: 'cameras/ahd'},
  {path: 'accessories', component: AccessoriesComponent},
  {path: 'accessories/:name', component: ProductPageComponent},
